...
public partial class @CameraControlInputs: IInputActionCollection2, IDisposable
{
    ...
    ~@CameraControlInputs()
    {
        UnityEngine.Debug.Assert(!m_CameraControlMap.enabled, "This will cause a leak and performance issues, CameraControlInputs.CameraControlMap.Disable() has not been called.");
    }
